...
int main(int argc, char **argv)
{
    ...
    
    {
        ...
        pSprite->setPosition(glm::vec2(300, 50));
        ...
        glm::mat4 projectionMatrix = glm::ortho(0.f, static_cast<float>(g_windowSize.x), 
                                                0.f, static_cast<float>(g_windowSize.y), -100.f, 100.f);
