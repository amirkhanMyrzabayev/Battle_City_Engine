...
bool Game::init()
{
    ...
    if (!pTextureAtlas)
    {
        std::cerr << "Can't find texture Atlas program: " << "mapTextureAtlas" << std::endl;
        return false;
    }
    ...
    {
        std::cerr << "Can't find texture Atlas program: " << "tanksTextureAtlas" << std::endl;
        return false;
    }
    ...
    m_pTank = std::make_unique<Tank>(pTanksAnimatedSprite, 0.00000005f, glm::vec2(0.f, 0.f), glm::vec2(16.f, 16.f));
