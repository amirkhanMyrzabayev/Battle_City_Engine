...
bool Game::init()
{
    ...
    modelMatrix1 = glm::translate(modelMatrix1, glm::vec3(0.f, 0.f, 0.f));

    glm::mat4 modelMatrix2 = glm::mat4(1.f);
    modelMatrix2 = glm::translate(modelMatrix2, glm::vec3(0.f, 0.f, 0.f));
    ...
    auto pTanksAnimatedSprite = ResourceManager::loadAnimatedSprite("NewTanksAnimatedSprite", "TanksTextureAtlas", "SpriteShader", 100, 100, "tankTop1");
    ...
    m_pTank = std::make_unique<Tank>(pTanksAnimatedSprite, 0.0000002f, glm::vec2(100, 100));
