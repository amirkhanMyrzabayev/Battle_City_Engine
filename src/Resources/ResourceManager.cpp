...
std::shared_ptr<Renderer::Texture2D> ResourceManager::loadTexture(const std::string& textureName, const std::string& texturePath)
{
	...
	std::shared_ptr<Renderer::Texture2D> newTexture = m_textures.emplace(textureName, std::make_shared<Renderer::Texture2D>(
																			  ...
																			  const std::string& subTextureName)
{
	...
	std::shared_ptr<Renderer::AnimatedSprite> newAnimatedSprite = m_animatedSprites.emplace(animatedSpriteName, 
